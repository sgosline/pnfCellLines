...
all.genes<-unique(fread(synGet("syn12973391")$path)$geneSymbol)
...
# tcga<-getSamplesForDisease(dis='',study='tcga')
# tcga.mut <- getDisMutationData(dis='',study='tcga')
# tcga.exp <- getDisExpressionData(dis='',study='tcga')
